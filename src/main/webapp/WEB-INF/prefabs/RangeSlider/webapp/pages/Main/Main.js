...
Prefab.getSlider = function() {
    if (Prefab.handlesSlider && Prefab.handlesSlider.noUiSlider) {
        ...
        if ((Prefab.step || Prefab.step === 0) && (Prefab.start || Prefab.start === 0) &&
            ...
            if (Prefab.showgaolamountcontainer == 'true') {
                Prefab.handlesSlider = document.getElementsByName('containerGoalAmount')[0];
                //Prefab.Widgets.containerGoalTime.show = false;

            } else if (Prefab.showgaolamountcontainer == 'false') {
                Prefab.handlesSlider = document.getElementsByName('containerGoalTime')[0];
                //Prefab.Widgets.containerGoalAmount.show = false;
            }
            //-- --
            if (!Prefab.handlesSlider) {
                return;
